...
if ($local_md5sig === $md5sig) {
    ...
    $orderDetails .= "<p><strong>Total Amount:</strong> PHP " . number_format($order['total'], 2) . "</p>";
    $orderDetails .= "<h3>Order Items:</h3><ul>";

    foreach ($order_items as $item) {
        $orderDetails .= "<li>{$item['product_name']} - Qty: {$item['quantity']} - Price: PHP " . number_format($item['price'], 2) . "</li>";
    }
    ...
    switch ($status_code) {
        case 2: // Payment successful
            ...
            $orderDetails .= "<p>Your payment has been received successfully. Thank you for shopping with AMICA Salon!</p>";
            sendOrderStatusEmail($order['email'], 'Order Completed - AMICA Salon', $orderDetails);
        ...
        case 0: // Payment pending
            ...
            sendOrderStatusEmail($order['email'], 'Order Pending - AMICA Salon', $orderDetails);
        ...
        case -1: // Payment canceled
            ...
            sendOrderStatusEmail($order['email'], 'Order Cancelled - AMICA Salon', $orderDetails);
        ...
        case -2: // Payment failed
            ...
            sendOrderStatusEmail($order['email'], 'Payment Failed - AMICA Salon', $orderDetails);
        ...
        case -3: // Chargeback
            ...
            sendOrderStatusEmail($order['email'], 'Chargeback Received - AMICA Salon', $orderDetails);
